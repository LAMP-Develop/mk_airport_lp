let spots = {
  ...
  haneda: ["東京都", "神奈川県", "埼玉県", "千葉県", "上記以外の地域"],
  narita: ["東京23区", "武蔵野三鷹市", "上記以外の地域"],
  chubu: ["愛知県", "静岡県", "岐阜県", "三重県", "松本市", "福井市", "金沢市", "京都府", "滋賀県"],
  itami: ["滋賀県", "京都府", "大阪府", "兵庫県", "奈良県", "和歌山県", "三重県", "岡山県"],
...
$(document).ready(function () {
  ...
  $("#pickup").on("change", function () {
    ...
    if (pickup_val != 0) {
      ...
      } else if (airport_val == 8 || airport_val == 9) {
        // 成田・羽田
      ...
      if (pickup_val == "札幌市") {
        ...
        lat.val(35.6129302);
        lng.val(140.1112894);
      } else if (pickup_val == "東京23区" || pickup_val == "上記以外の地域") {
        lat.val(35.6812405);
        lng.val(139.7649361);
      } else if (pickup_val == "武蔵野三鷹市") {
        lat.val(35.7027199);
